    ...
    <div style={{ minHeight: "100vh", display: "flex", width: "100vw", background: "transparent", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ width: "43%", minWidth: 440, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 60px", zIndex: 10, position: "relative" }}>
        ...
        <div className="glass-panel-neon" style={{ padding: "40px 45px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 36 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 9.5, color: "#00E5FF", letterSpacing: 2.5, fontWeight: 700 }}>ISRO MISSION CONTROL</div>
            </div>
          </div>
          ...
          <div style={{ marginBottom: 20 }}>
            <label style={{ display: "block", fontSize: 10, color: "#00E5FF", letterSpacing: 1.8, fontWeight: 700, marginBottom: 8 }}>MISSION SCIENTIST ID</label>
            <input
              defaultValue="isro.scientist@isro.gov.in"
          ...
          <div style={{ marginTop: 24, display: "flex", justifyContent: "space-between", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: 18 }}>
            ...
            <div style={{ fontSize: 11, color: "#64748B", display: "flex", alignItems: "center", gap: 5 }}><Wifi size={12} color="#00E5FF" /> SAC CHANNEL</div>
        ...
        <div style={{ marginTop: 20, textAlign: "center", fontSize: 11, color: "#64748B", fontFamily: "'JetBrains Mono',monospace", letterSpacing: 0.5 }}>
          ISRO SPACE APPLICATIONS CENTRE · HACKATHON 2026
        </div>
      </div>
  ...
  const sections = [
    {
      title: "MISSION",
      items: [
        { id: "dashboard", label: "Mission Dashboard", Icon: LayoutDashboard, live: false },
        { id: "viewer", label: "Frame Viewer", Icon: Eye, live: true },
        { id: "metrics", label: "AI Analytics", Icon: BarChart2, live: false }
      ]
    },
    {
      title: "MONITORING",
      items: [
        { id: "satellites", label: "Satellite Network", Icon: Satellite, live: true },
        { id: "events", label: "Event Detection", Icon: AlertTriangle, live: true, badge: 5 },
    ...
    },
    {
      title: "SYSTEM",
      items: [
        { id: "downloads", label: "Downloads", Icon: Download, live: false },
        ...
        <div style={{ display: "flex", alignItems: "center", gap: collapsed ? 0 : 10 }}>
          ...
          {!collapsed && (
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ fontSize: 8, color: "rgba(0,229,255,0.75)", letterSpacing: 1.5, fontWeight: 700, marginTop: 1 }}>ISRO SAC</div>
            </div>
          )}
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span style={{ fontSize: 9, color: "rgba(0, 229, 255, 0.8)", letterSpacing: "1px", fontWeight: 700, textTransform: "uppercase" }}>
            ISRO SAC <span style={{ color: "#475569", margin: "0 4px" }}>|</span> <span style={{ color: "white" }}>{navLabel}</span>
          </span>
        </div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          {[
            { Icon: Satellite, label: "5 Satellites Online", color: "#00E5FF", bg: "rgba(0, 229, 255, 0.04)", border: "rgba(0, 229, 255, 0.15)" },
            { Icon: Cpu, label: "142 Jobs Running", color: "#7B61FF", bg: "rgba(123, 97, 255, 0.04)", border: "rgba(123, 97, 255, 0.15)" },
            { Icon: AlertTriangle, label: "5 Active Alerts", color: "#FF3B5C", bg: "rgba(255, 59, 92, 0.04)", border: "rgba(255, 59, 92, 0.15)" }
        ...
        <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", textAlign: "left" }}>
              <span style={{ fontSize: 10.5, fontWeight: 700, color: "white" }}>Dr. A. Sharma</span>
              <span style={{ fontSize: 8.5, color: "#64748B" }}>ISRO Scientist</span>
            </div>
...
function GlobalTelemetryStrip({ elapsedSeconds }: { elapsedSeconds: number }) {
  ...
  const confidence = (94.2 + (elapsedSeconds % 5) * 0.05).toFixed(1);
  const latency = (2.2 + (elapsedSeconds % 4) * 0.05).toFixed(2);
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <span style={{ display: "flex", alignItems: "center", gap: 4, fontWeight: 800, color: "#00F593" }}>
          <span style={{ width: 4.5, height: 4.5, borderRadius: "50%", background: "#00F593", display: "inline-block", animation: "pulse-dot 1s infinite" }} />
          MISSION ACTIVE
        </span>
        <span style={{ color: "#334155" }}>|</span>
        <span>SAT: <span style={{ color: "white", fontWeight: 700 }}>INSAT-3DS</span></span>
        <span style={{ color: "#334155" }}>|</span>
        <span>RES: <span style={{ color: "#00E5FF" }}>30m → 15m → 7.5m</span></span>
      </div>

      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <span>STAGE: <span style={{ color: "#7B61FF", fontWeight: 700 }}>TemporalNet v2.1</span></span>
        <span style={{ color: "#334155" }}>|</span>
        <span>QUEUE: <span style={{ color: "white" }}>12 / 16 Frames</span></span>
        <span style={{ color: "#334155" }}>|</span>
        <span>CONFIDENCE: <span style={{ color: "#00F593", fontWeight: 700 }}>{confidence}%</span></span>
      </div>

      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <span>ENGINE: <span style={{ color: "#00E5FF" }}>{fps} FPS</span></span>
        <span style={{ color: "#334155" }}>|</span>
        <span>LATENCY: <span style={{ color: "#FFB800" }}>{latency}s</span></span>
        <span style={{ color: "#334155" }}>|</span>
        <span>MET: <span style={{ color: "white", fontWeight: 700 }}>{elapsedStr}</span></span>
      </div>
    </div>
  );
}
        ...
        <div style={{ display: "flex", height: "100vh", overflow: "hidden", fontFamily: "var(--font-sans)", color: "#E2E8F0" }}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative", zIndex: 10 }}>
            ...
            <div className="scroll-hide" style={{ flex: 1, overflowY: nav === "viewer" ? "hidden" : "auto" }}>
              {nav === "dashboard"  && <DashboardScreen elapsedSeconds={elapsedSeconds} />}
              {nav === "viewer"     && <ViewerScreen />}
              {nav === "satellites" && <SatellitesScreen />}
              {nav === "metrics"    && <MetricsScreen />}
              {nav === "events"     && <EventsScreen />}
              {nav === "xai"        && <XAIScreen />}
